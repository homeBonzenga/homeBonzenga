...
const SearchPage = () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        const transformedVendors: Vendor[] = data.vendors.map((vendor: any) => ({
          ...
          category: 'hair', // Could be derived from services
          location: vendor.city.toLowerCase(),
          serviceType: 'salon', // Default to salon
          rating: 4.5, // Default rating
          reviewCount: 0,
          services: vendor.services?.map((s: any) => s.name) || ['Service'],
          priceRange: '$30-$100',
          price: 50, // Default price
          image: hair4, // Default image
          verified: true,
          available: 'today'
        }));
  ...
  // Use vendors from API or fallback to mock data
