...
CREATE TABLE "new_bookings" (
    ...
    "employeeId" TEXT,
    "bookingType" TEXT NOT NULL DEFAULT 'AT_HOME',
...
INSERT INTO "new_bookings" ("addressId", "cancellationReason", "createdAt", "customerId", "discount", "duration", "employeeId", "id", "notes", "scheduledDate", "scheduledTime", "status", "subtotal", "tax", "total", "updatedAt", "vendorId") SELECT "addressId", "cancellationReason", "createdAt", "customerId", "discount", "duration", "employeeId", "id", "notes", "scheduledDate", "scheduledTime", "status", "subtotal", "tax", "total", "updatedAt", "vendorId" FROM "bookings";
DROP TABLE "bookings";
